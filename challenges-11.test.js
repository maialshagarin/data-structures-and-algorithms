...
const validateEmail = (email) => {
    var validemail =/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/; ////// i take the expression from overflow stalk i don't write it
...
const validatePhoneNumber = (phoneNumber) => {
  // Solution code here...
  let validatorPhoneNumber = /^((\d{3})|(\(\d{3}\)))[ -]?\d{3}[ -]?\d{4}$/; //////// i use this website to help me do it https://docs.microsoft.com/en-us/dotnet/standard/base-types/the-regular-expression-object-model ///////
